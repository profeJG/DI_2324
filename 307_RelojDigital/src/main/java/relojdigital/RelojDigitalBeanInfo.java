...
public class RelojDigitalBeanInfo extends SimpleBeanInfo {
    ...
    private static final int METHOD_removeAlarmaListener111 = 111;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_removeAlarmaListener111] = new MethodDescriptor(relojdigital.RelojDigital.class.getMethod("removeAlarmaListener", new Class[] {})); // NOI18N
            methods[METHOD_removeAlarmaListener111].setDisplayName ( "" );
